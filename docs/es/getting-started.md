...
- **Linux** — haz ejecutable el AppImage (`chmod +x Maker.Studio_x86_64.AppImage`) y ejecútalo. Usa el WebKit de tu sistema: si no arranca, instala `webkit2gtk-4.1` y `gtk3` (Arch) o `libwebkit2gtk-4.1-0` y `libgtk-3-0` (Debian/Ubuntu). El `.deb` se instala con `sudo apt install ./Maker.Studio_amd64.deb`. El AppImage se actualiza solo desde el actualizador integrado (mantiene la misma ruta de fichero, así que los lanzadores siguen funcionando); el `.deb` no — instala el paquete nuevo desde la [página de releases](https://github.com/Toskan4134/maker-studio/releases/latest).
...
|-------------|------------------|
| Pokémon Essentials **v21.1** (vanilla) | [`PE21.1.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/PE21.1.Maker.Studio.v1.6.1.zip) |
| Pokémon Essentials **v20.1** (vanilla) | [`PE20.1.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/PE20.1.Maker.Studio.v1.6.1.zip) |
| Pokémon Essentials **v19.1** (vanilla) | [`PE19.1.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/PE19.1.Maker.Studio.v1.6.1.zip) |
| Pokémon Essentials **v17.1** (vanilla) | [`PE17.1.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/PE17.1.Maker.Studio.v1.6.1.zip) |
| La Base de Sky **1.1.x** | [`LBDS1.1.0.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/LBDS1.1.0.Maker.Studio.v1.6.1.zip) |
| La Base de Sky **1.2.x** | [`LBDS1.2.0.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/LBDS1.2.0.Maker.Studio.v1.6.1.zip) |
| Pokémon Essentials **BES v5** | [`BES5.Maker.Studio.zip`](https://github.com/Toskan4134/maker-studio/releases/download/integrations-v1.6.1/BES5.Maker.Studio.v1.6.1.zip) |
