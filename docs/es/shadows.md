...
Haz clic en **Presets…** en la cabecera del popup de configuración de sombra para abrir el gestor de presets. Guarda la combinación actual de dirección / altura / tint / opacidad / offsets como un preset con nombre y aplícalo después a cualquier sombra nueva con un clic. El diálogo también admite renombrar, sobrescribir y eliminar, y permite seleccionar varios presets (Ctrl/Mayús+clic, o clic en el nombre de una carpeta) para moverlos, exportarlos o eliminarlos juntos. Usa **Exportar…** para escribir los presets en una carpeta — los seleccionados, o todos si no hay nada seleccionado — cada uno como su propio archivo `ms_<name>_<index>_preset.json`, e **Importar…** para traer de vuelta uno o varios archivos de preset a la vez (para copias de seguridad o compartir entre equipos). Los presets se guardan por instalación (compartidos entre todos tus proyectos) y se recuerdan entre sesiones.
