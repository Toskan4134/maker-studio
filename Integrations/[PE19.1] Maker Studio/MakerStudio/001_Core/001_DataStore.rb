  ...
  module DataStore
    ...
    def load_extended_data(map_id, game_map = nil)
      ...
      begin
        ...
        # v19.1 HAS a Console module, but it only holds setup_console/readInput —
        # echoln/echo_error are Kernel methods. A `defined?(Console)` guard would
        # pass here and then NoMethodError, so log through the Kernel global.
