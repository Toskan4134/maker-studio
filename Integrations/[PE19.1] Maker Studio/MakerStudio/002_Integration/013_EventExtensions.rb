...
#
# Essentials 19.1 has no variableIsLessThan?, so the condition tree's variable
# branch reads $game_variables directly (the same comparison the core refresh
# uses), not the helper the v21.1/LBDS builds use.
#===============================================================================
