...
Or run `maker-studio.exe` directly from `Plugins/MakerStudio/003_Editor/`.
...
MakerStudio/
  ...
  002_Integration/
    001_Hooks.rb                  - Debug menu entries and lifecycle event handlers
  ...
  003_Editor/
    maker-studio.exe      - Tauri v2 desktop editor application
